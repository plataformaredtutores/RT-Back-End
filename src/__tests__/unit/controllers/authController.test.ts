...
describe('Auth Controller - Unit Tests', () => {
  ...
  describe('login', () => {
    it('should successfully login with valid credentials', async () => {
      ...
      expect(mockResponse.cookie).toHaveBeenCalledWith('access_token', mockAccessToken, expect.any(Object));
  ...
  describe('refreshToken', () => {
    it('should successfully refresh token with valid refresh token', async () => {
      ...
      (prisma.refreshToken.findMany as jest.Mock) = jest.fn().mockResolvedValue([mockRefreshTokenRecord]);
